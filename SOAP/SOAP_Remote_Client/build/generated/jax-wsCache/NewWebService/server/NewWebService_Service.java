 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://server/", wsdlLocation = "http://192.168.118.105:8080/SOAP_server/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://server/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.118.105:8080/SOAP_server/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://server/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "NewWebServicePort"), NewWebService.class, features);
    }
